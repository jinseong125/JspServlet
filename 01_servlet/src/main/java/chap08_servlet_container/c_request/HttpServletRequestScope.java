...
public class HttpServletRequestScope extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   * 3. 주로 RequestDispatcher를 이용한 forward 시 데이터를 전달하기 위해서 사용됩니다.
	   * 4.  데이터 처리 예시
     *    1) 저장 : requeset.setAttribute(String key, object value);
     ...
     *    3) 삭제 : request.removeAttribute(String key)
	  ...
	  List<Map<String, Object>> products = Arrays.asList(
	      Map.of("model", "AAA", "price", 1000),
	      Map.of("model", "BBB", "price", 2000),
	      Map.of("model", "CCC", "price", 3000)
	  );
